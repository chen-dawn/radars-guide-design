...
exports.renderEditTaxCode = renderEditTaxCode;
...
function EditTaxCode(props) {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_Select.default, {
    ...
    fullWidth: true,
    open: true,
    children: _staticData.TAXCODE_OPTIONS.map(option => {
...
function renderEditTaxCode(params) {
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(EditTaxCode, (0, _extends2.default)({}, params));
}