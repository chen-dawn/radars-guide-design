...
exports.renderEditRateType = renderEditRateType;
...
function EditRateType(props) {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_Select.default, {
    ...
    fullWidth: true,
    open: true,
    children: _staticData.RATE_TYPE_OPTIONS.map(option => {
...
function renderEditRateType(params) {
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(EditRateType, (0, _extends2.default)({}, params));
}